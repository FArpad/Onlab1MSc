...
using Company.ResultPackage;

namespace ResultPackage_UnitTests.MyToolWindowTest
{
    [TestClass()]
    public class ShowToolWindowTest
    {
        ...
        {
            IVsPackage package = new ResultPackagePackage() as IVsPackage;
            ...
            MethodInfo method = typeof(ResultPackagePackage).GetMethod("ShowToolWindow", BindingFlags.NonPublic | BindingFlags.Instance);
